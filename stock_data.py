...
# data management + web scraping + csv import -> backend module
import sqlite3
...
def retrieve_stock_web(dateStart,dateEnd,stock_list):
    ...
    recordCount = 0
    chrome_path = "/Users/annie/Library/CloudStorage/OneDrive-Personal/Academics/Masters/SJSU/DATA-200/Lab__2/chromedriver"
    ...
    for stock in stock_list:
        ...
        try:
            service = webdriver.chrome.service.Service(executable_path=chrome_path) # added this to show chrome driver path
